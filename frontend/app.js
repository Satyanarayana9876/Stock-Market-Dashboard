...
async function renderApexChart(symbol, range) {
    try {
        ...
        const startPrice = Array.isArray(seriesData[0].y)
                            ? seriesData[0].y[3]
                            : seriesData[0].y;
        const endPrice = Array.isArray(seriesData[seriesData.length - 1].y)
                            ? seriesData[seriesData.length - 1].y[3]
